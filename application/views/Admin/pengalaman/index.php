          ...
          <div class="container-fluid">
            ...
            <?php foreach ($pengalaman as $data){ ?>
                  <tr>
                    ...
                    <td>
                        <a class="btn btn-warning" href="<?php echo site_url('admin/pengalaman/edit/'.$data->id)?>">
                          <i class="fa fa-edit"></i>
                        </a>
                        <a type="button" rel="tooltip" title="Hapus" class="btn btn-danger" onclick="deleteConfirm('<?php echo site_url('admin/pengalaman/delete/'.$data->id)?>')">
      ...
      <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" action="<?= base_url('admin/pengalaman/add')?>" method="post">
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-grup">
                    <label>No</label>
              ...
              <div class="row">
                  <div class="col-md-6">
                    <div class="form-grup">
                    <label>Waktu</label>
                    <input type="text" name="waktu_peng" class="form-control" placeholder="Waktu . ." value="">
                  </div>
                </div>
              </div>
              <div class="row">
                  <div class="col-md-6">
                    <div class="form-grup">
                    <label>Nama</label>
                    <input type="text" name="nama_peng" class="form-control" placeholder="Nama . ." value="">
                  </div>
                </div>
              </div>
              <div class="row">
                  <div class="col-md-6">
                    ...
                    <input type="text" name="ket_peng" class="form-control" placeholder="Keterangan . ." value="">
                  </div>
                </div>
              </div>
            <div class="modal-footer">
